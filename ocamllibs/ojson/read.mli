(* $Id: read.mli 63 2011-04-27 00:27:03Z mjambon $ *)
...
val stream_from_lexbuf :
  lexer_state ->
  ?fin:(unit -> unit) ->
  Lexing.lexbuf -> Type.json Stream.t
...
val finish_variant : lexer_state -> Lexing.lexbuf -> Type.json option
...
val read_json : lexer_state -> Lexing.lexbuf -> Type.json
