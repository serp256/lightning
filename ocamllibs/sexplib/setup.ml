(* OASIS_START *)
(* DO NOT EDIT (digest: 97fe1c1b269481515d772062c35aec2a) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build top library";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "fìÛ\003ÿ\012ÒIN\031\152j\r8\026¸";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
