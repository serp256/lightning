...
- (void)presentResult:(NSData *)data {
    NSError *jsonError;
    NSDictionary *responseDict = [data objectFromJSONDataWithParseOptions:0 error:&jsonError];  // [NSJSONSerialization JSONObjectWithData:data options:0 error:&jsonError];
