...
+ (NSString *)startForAppId:(NSString *)appId
              ...
              securityToken:(NSString *)securityToken
{
    return [[self instance] startForAppId:appId userId:userId securityToken:securityToken withNetworks:nil];
}
...
{
    return [[self instance] startForAppId:appId userId:userId securityToken:securityToken withNetworks:networks];
}
                                 ...
                                 securityToken:(NSString *)securityToken
{
    ...
    return [self startForAppId:appId userId:userId securityToken:securityToken withNetworks:nil];
}
              ...
              withNetworks:(NSArray*)networks
{
    if (!userId || [userId isEqualToString:@""]) {
        NSString *exceptionReason = @"No user id could be found. Please specify an user or use [startWithAutogeneratedUserForAppId:securityToken:] instead";
        NSException* noValidUserIdException =
        [NSException exceptionWithName:@"SponsorPayInvalidUserId"
                                reason:exceptionReason
                              userInfo:nil];
        @throw noValidUserIdException;
    }
    ...
    [SPTPNManager startNetworks:networks];
...
- (void)vcsPayoffReceived:(NSNotification *)notification
{
    ...
    @catch (NSException *invalidCredentialsTokenException) {
        SPLogWarn(@"Won't show notification to the user: %@", invalidCredentialsTokenException);
    }
}
