...
public class TapjoyFeaturedApp
{
	...
	private int displayCount = 5;											// By default, each full screen ad is only displayed five times before it no longer being displayed.
	...
	/**
	 * Connects to the server and to get full screen ad data.
	 * @param notifier				Class which receives callback with Full Screen Ad data.
	 */
	public void getFeaturedApp(TapjoyFeaturedAppNotifier notifier)
	{
		TapjoyLog.i(TAPJOY_FEATURED_APP, "Getting Full Screen Ad");
	...
	public void getFeaturedApp(String theCurrencyID, TapjoyFeaturedAppNotifier notifier)
	{
		...
		TapjoyLog.i(TAPJOY_FEATURED_APP, "Getting Full Screen Ad userID: " + TapjoyConnectCore.getUserID() + ", currencyID: " + currencyID);
	...
	/**
	 * Sets the maximum number of times a full screen ad ad should appear.
	...
	private boolean buildResponse(String response)
	{
		...
		if (retValue)
		{
			...
			{
				// Send the Full Screen Ad data to the callback and increment the count for this ID.
	...
	/**
	 * Returns the number of times an app has been displayed as a full screen ad ad.
	...
	/**
	 * Increments the number of times an app has been displayed as a full screen ad ad.
	 * @param storeID			ID of the app to check.
	 */
	...
	/**
	 * Returns the Full Screen Ad Object containing Full Screen Ad data.
	 * @return					Full Screen Ad Object
	 */
