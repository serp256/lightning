...
//		clientPackage = TapjoyConnectCore.getClientPackage();
	...
	protected void onResume()
	{
		...
		{
			TapjoyLog.i(TAPJOY_FEATURED_APP, "call connect");
	...
	/**
	 * Allows access to the webview to show the offer wall (when Show More Apps is pressed on the full screen ad page).
	 */
	...
	/**
	 * Allows access to the webview to close this activity (when SKIP is pressed on full screen ad page).
	 */
