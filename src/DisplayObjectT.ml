...
class type virtual _c ['evType,'evData,'parent] =
  object
    ...
    type 'parent = 
      < 
        asDisplayObject: _c _ _ _; removeChild': _c _ _ _ -> unit; dispatchEvent': !'ct. Event.t 'evType 'evData _ (< .. > as 'ct) -> unit; 
        name: string; transformationMatrixToSpace: option (_c _ _ _) -> Matrix.t; stage: option 'parent; height: float; .. >;
  ...
  object('self)
    ...
    type 'parent = 
      < 
        ...
        name: string; transformationMatrixToSpace: !'space. option (<asDisplayObject: _c _; ..> as 'space) -> Matrix.t; stage: option 'parent; height: float; .. >;
(*     inherit EventDispatcher.c [ 'event_type, 'event_data , _c _ _ _, _]; *)
...
class virtual container:
  object
    ...
    method renderInRect: Rectangle.t -> unit;
