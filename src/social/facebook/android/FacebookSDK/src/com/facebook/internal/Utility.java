...
public final class Utility {
    ...
    public static String getMetadataApplicationId(Context context) {
        try {
            ...
            Log.d("LIGHTNING", "ai.metaData " + ai.metaData);

            if (ai.metaData != null) {
                Log.d("LIGHTNING", "ai.metaData.getString(Session.APPLICATION_ID_PROPERTY) " + ai.metaData.getString(Session.APPLICATION_ID_PROPERTY));
